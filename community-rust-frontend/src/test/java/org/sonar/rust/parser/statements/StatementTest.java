...
public class StatementTest {
  ...
  public void testStatements() {
    assertThat(RustGrammar.create().build().rule(RustGrammar.STATEMENTS))
      ...
      .matches("mystruct{};")
      .matches("test() ;")
      // TOOD.matches("quote!{}.into()")
      .matches("let a=42; c.d()")
      .matches("let a=42; let b = 43;c.d()")
      // TOOD.matches("let a=42; quote!{}.into()")
      // TOOD.matches("let a=42; let b = 43;quote!{}.into()")
      // TOOD.matches("extern crate foo; let b = 43;quote!{}.into()")
      // TOOD.matches("let a=42;\n extern crate bar;\nquote!{}.into()")
      .matches("let a=42;\n extern crate bar;\nc.d()")
      // TOOD.matches("quote!{}.into();let a=42;\n extern crate bar;\nquote!{}.into()")
      .matches("quote!(i).into()")
      .matches("quote![j].into()")
    // TOOD.matches("quote!{k}.into()")
