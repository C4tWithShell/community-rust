...
public enum RustGrammar implements GrammarRuleKey {
  ...
  private static void useItem(LexerlessGrammarBuilder b) {
    ...
    b.rule(USE_TREE).is(b.firstOf(
      b.sequence(b.optional(b.optional(SIMPLE_PATH), SPC, RustPunctuator.PATHSEP, SPC), RustPunctuator.STAR),
      b.sequence(b.optional(b.optional(SIMPLE_PATH), SPC, RustPunctuator.PATHSEP, SPC),
  ...
  private static void patterns(LexerlessGrammarBuilder b) {
    ...
    b.rule(PATTERN_WITHOUT_RANGE).is(b.firstOf(
      ...
      b.firstOf(
        b.sequence(b.optional(SPC, RustPunctuator.PATHSEP, SPC),
          // PATH_EXPR_SEGMENT,
          ...
          b.oneOrMore(b.sequence(SPC, RustPunctuator.PATHSEP, SPC, PATH_EXPR_SEGMENT))),
        QUALIFIED_PATH_IN_EXPRESSION),
      BYTE_LITERAL,
      RAW_STRING_LITERAL,
      BYTE_STRING_LITERAL,
  ...
  public static void expressions(LexerlessGrammarBuilder b) {
    ...
    b.rule(EXPRESSION).is(
      ...
      b.firstOf(
        ...
        b.sequence(RustPunctuator.DOTDOT, b.nextNot(RustPunctuator.EQ), SPC, EXPRESSION),
    ...
    b.rule(EXPRESSION_TERM).is(
      b.firstOf(
        ...
        b.sequence(RustPunctuator.DOTDOT, b.nextNot(RustPunctuator.EQ), b.optional(SPC, EXPRESSION)),
        b.sequence(RustPunctuator.DOT, RustKeyword.KW_AWAIT, b.nextNot(IDENTIFIER), SPC, EXPRESSION_TERM),
        b.sequence(RustPunctuator.DOT, SPC, PATH_EXPR_SEGMENT, SPC, "(", SPC, b.optional(CALL_PARAMS, SPC), ")", SPC, EXPRESSION_TERM),
        b.sequence(RustPunctuator.DOT, SPC, TUPLE_INDEX, SPC, EXPRESSION_TERM),
        b.sequence(RustPunctuator.DOT, SPC, IDENTIFIER, SPC, EXPRESSION_TERM),
  ...
  private static void range(LexerlessGrammarBuilder b) {
    ...
    b.rule(RANGE_EXPRESSION).is(b.firstOf(
      ...
      b.sequence(EXPRESSION, RustPunctuator.DOTDOTEQ, SPC, EXPRESSION),
      b.sequence(EXPRESSION, RustPunctuator.DOTDOT, SPC, EXPRESSION)));

    b.rule(RANGE_EXPR).is(EXPRESSION, RustPunctuator.DOTDOT, SPC, EXPRESSION);
    b.rule(RANGE_FROM_EXPR).is(EXPRESSION, RustPunctuator.DOTDOT);
    b.rule(RANGE_INCLUSIVE_EXPR).is(EXPRESSION, RustPunctuator.DOTDOTEQ, SPC, EXPRESSION);
    b.rule(RANGE_TO_EXPR).is(RustPunctuator.DOTDOT, SPC, EXPRESSION);
    b.rule(RANGE_FULL_EXPR).is(RustPunctuator.DOTDOT);
    b.rule(RANGE_TO_INCLUSIVE_EXPR).is(RustPunctuator.DOTDOTEQ, SPC, EXPRESSION);
  }
  ...
  public static void lexicalpath(LexerlessGrammarBuilder b) {
    ...
    b.rule(PATH_IN_EXPRESSION).is(
      ...
      PATH_EXPR_SEGMENT,
      b.zeroOrMore(b.sequence(SPC, RustPunctuator.PATHSEP, SPC, PATH_EXPR_SEGMENT)));

    b.rule(PATH_EXPR_SEGMENT).is(
      PATH_IDENT_SEGMENT, b.optional(b.sequence(SPC, RustPunctuator.PATHSEP, SPC, GENERIC_ARGS)));
    ...
    b.rule(QUALIFIED_PATH_IN_EXPRESSION).is(
      QUALIFIED_PATH_TYPE, b.oneOrMore(b.sequence(SPC, RustPunctuator.PATHSEP, SPC, PATH_EXPR_SEGMENT)));
    ...
    b.rule(QUALIFIED_PATH_IN_TYPE).is(QUALIFIED_PATH_TYPE, b.oneOrMore(
      b.sequence(SPC, RustPunctuator.PATHSEP, SPC, TYPE_PATH_SEGMENT)
    ...
    b.rule(TYPE_PATH).is(
      ...
      b.optional(SPC, RustPunctuator.PATHSEP, SPC),
      TYPE_PATH_SEGMENT,
      b.zeroOrMore(SPC, RustPunctuator.PATHSEP, SPC, TYPE_PATH_SEGMENT)
